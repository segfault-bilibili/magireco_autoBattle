...
function algo_init() {
    ...
    const binURLBase = "https://cdn.jsdelivr.net/gh/segfault-bilibili/magireco_autoBattle@2.4.37";
    ...
    //已知参照图像，包括A/B/C盘等
    const ImgURLBase = "https://cdn.jsdelivr.net/gh/segfault-bilibili/magireco_autoBattle@2.4.37";
    var knownImgs = {};
    const knownImgURLs = {
