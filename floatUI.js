...
function algo_init() {
    ...
    const binURLBase = "https://cdn.jsdelivr.net/gh/segfault-bilibili/magireco_autoBattle@2.4.36";
    ...
    const ImgURLBase = "https://cdn.jsdelivr.net/gh/segfault-bilibili/magireco_autoBattle@2.4.36";
    var knownImgs = {};
    const knownImgURLs = {
